...
class SpacialTextPadding {
    ...
    public function generate($sourceString) {
        ...
        $this->originalString = $this->sourceString;
        $this->sourceString = trim(preg_replace("/\s+/", " ", $this->sourceString));
        $this->originalString = $this->sourceString;
        $this->prepare();
    ...
    private function prepare() {
        ...
        if($this->textCase == TextCase::AlikeCase) {
